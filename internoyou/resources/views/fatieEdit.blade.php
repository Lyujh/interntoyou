...
@section('content')
    ...
    <DIV>
        <FORM onsubmit="return check()" method="post" name="postForm" action="{{ url('doTieziEdit') }}">
            @csrf
            <DIV class="t">
                <TABLE cellSpacing="0" cellPadding="0" align="center">
                    <TBODY>
                    <TR>
                        <TD class="h" colSpan="3"><B>Modify post</B></TD>
                    </TR>
                    <TR class=tr3>
                        ...
                        <TH>
                            ...
                            <INPUT type="hidden" name="tie_id" value="{{ $tiezi->tie_id }}">
                            <INPUT style="PADDING-LEFT: 2px; FONT: 14px Tahoma" class="input" tabIndex="1" size="60"
                                   name="title" value="{{ $tiezi->title }}">
                    ...
                    <TR class="tr3">
                        ...
                        <TH colSpan=2>
                            <DIV>
                                <SPAN>
                                    <TEXTAREA style="WIDTH: 500px" tabIndex="2" rows="20" cols="90" name="content">{{ $tiezi->content }}</TEXTAREA>
